...
class Roomba(Node):
	...
	def ir_opcode_callback(self, msg): ########## Revert to elif in case this is too much to debug
		opcode_actions = {
	...
	def drive_adjust(self, turn_right=False, move_forward=False, move_back=False):
		"""
		...
		"""
		if move_back:
			self.drive_amnt(-0.05)

		if turn_right:
			self.rotate_amnt(-pi/16)
