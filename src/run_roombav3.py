...
from Roomba_skeletonv3 import Roomba
...
############################################### Convert to this mode of using keycom. Requires combining different 
# commands for undocking, random rotation, backtracking, etc. Then implement the docking moves
if __name__ == '__main__':
