...
class DockStatusMonitorNode(Node):
    def __init__(self, namespace):
        super().__init__('dock_status_monitor_node')
        ...
        self.pose_publisher = self.create_publisher(PoseStamped, f'/{namespace}/pose_stamped', 10)

        # Subscription to the dock_status topic to receive DockStatus messages
        self.dock_status_subscriber_ = self.create_subscription(
            DockStatus, 
    ...
    def dock_status_callback(self, msg):
        ...
        self.current_dock_status = str(msg.is_docked)
