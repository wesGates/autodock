    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'irobot_create_msgs.action.Dock_Goal')
            logger.debug(
...
class Metaclass_Dock_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'irobot_create_msgs.action.Dock_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Dock_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'irobot_create_msgs.action.Dock_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Dock_Feedback(metaclass=Metaclass_Dock_Feedback):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.sees_dock = kwargs.get('sees_dock', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.sees_dock != other.sees_dock:
            return False
        return True
    ...
    @builtins.property
    def sees_dock(self):
        """Message field 'sees_dock'."""
        return self._sees_dock

    @sees_dock.setter
    def sees_dock(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'sees_dock' field must be of type 'bool'"
        self._sees_dock = value
...
class Dock_SendGoal_Request(metaclass=Metaclass_Dock_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'irobot_create_msgs/Dock_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['irobot_create_msgs', 'action'], 'Dock_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from irobot_create_msgs.action._dock import Dock_Goal
...
class Metaclass_Dock_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'irobot_create_msgs.action.Dock_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from irobot_create_msgs.action import _dock
...
class Dock_SendGoal(metaclass=Metaclass_Dock_SendGoal):
    from irobot_create_msgs.action._dock import Dock_SendGoal_Request as Request
    from irobot_create_msgs.action._dock import Dock_SendGoal_Response as Response
...
class Dock_GetResult_Response(metaclass=Metaclass_Dock_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'irobot_create_msgs/Dock_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['irobot_create_msgs', 'action'], 'Dock_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from irobot_create_msgs.action._dock import Dock_Result
...
class Metaclass_Dock_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'irobot_create_msgs.action.Dock_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Dock_GetResult(metaclass=Metaclass_Dock_GetResult):
    from irobot_create_msgs.action._dock import Dock_GetResult_Request as Request
    from irobot_create_msgs.action._dock import Dock_GetResult_Response as Response
...
class Metaclass_Dock_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'irobot_create_msgs.action.Dock_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Dock_FeedbackMessage(metaclass=Metaclass_Dock_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'irobot_create_msgs/Dock_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['irobot_create_msgs', 'action'], 'Dock_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from irobot_create_msgs.action._dock import Dock_Feedback
...
class Dock(metaclass=Metaclass_Dock):
    ...
    from irobot_create_msgs.action._dock import Dock_Goal as Goal
    # The result message defined in the action definition.
    from irobot_create_msgs.action._dock import Dock_Result as Result
    # The feedback message defined in the action definition.
    from irobot_create_msgs.action._dock import Dock_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from irobot_create_msgs.action._dock import Dock_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from irobot_create_msgs.action._dock import Dock_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from irobot_create_msgs.action._dock import Dock_FeedbackMessage as FeedbackMessage
