...
bool irobot_create_msgs__msg__led_color__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("irobot_create_msgs.msg._led_color.LedColor", full_classname_dest, 42) == 0);
  }
  irobot_create_msgs__msg__LedColor * ros_message = _ros_message;
  {  // red
...
{
  /* NOTE(esteve): Call constructor of LedColor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("irobot_create_msgs.msg._led_color");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LedColor");
