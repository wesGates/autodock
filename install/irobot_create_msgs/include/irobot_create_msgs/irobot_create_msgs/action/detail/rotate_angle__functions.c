...
irobot_create_msgs__action__RotateAngle_Goal__create()
{
  ...
  irobot_create_msgs__action__RotateAngle_Goal * msg = (irobot_create_msgs__action__RotateAngle_Goal *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__action__RotateAngle_Goal__Sequence__init(irobot_create_msgs__action__RotateAngle_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__action__RotateAngle_Goal *)allocator.zero_allocate(size, sizeof(irobot_create_msgs__action__RotateAngle_Goal), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_Goal__Sequence * array = (irobot_create_msgs__action__RotateAngle_Goal__Sequence *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__action__RotateAngle_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__action__RotateAngle_Goal * data =
      (irobot_create_msgs__action__RotateAngle_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__action__RotateAngle_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__action__RotateAngle_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_Result * msg = (irobot_create_msgs__action__RotateAngle_Result *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__action__RotateAngle_Result__Sequence__init(irobot_create_msgs__action__RotateAngle_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__action__RotateAngle_Result *)allocator.zero_allocate(size, sizeof(irobot_create_msgs__action__RotateAngle_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_Result__Sequence * array = (irobot_create_msgs__action__RotateAngle_Result__Sequence *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__action__RotateAngle_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__action__RotateAngle_Result * data =
      (irobot_create_msgs__action__RotateAngle_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__action__RotateAngle_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__action__RotateAngle_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_Feedback * msg = (irobot_create_msgs__action__RotateAngle_Feedback *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__action__RotateAngle_Feedback__Sequence__init(irobot_create_msgs__action__RotateAngle_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__action__RotateAngle_Feedback *)allocator.zero_allocate(size, sizeof(irobot_create_msgs__action__RotateAngle_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_Feedback__Sequence * array = (irobot_create_msgs__action__RotateAngle_Feedback__Sequence *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__action__RotateAngle_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__action__RotateAngle_Feedback * data =
      (irobot_create_msgs__action__RotateAngle_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__action__RotateAngle_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__action__RotateAngle_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_SendGoal_Request * msg = (irobot_create_msgs__action__RotateAngle_SendGoal_Request *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__action__RotateAngle_SendGoal_Request__Sequence__init(irobot_create_msgs__action__RotateAngle_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__action__RotateAngle_SendGoal_Request *)allocator.zero_allocate(size, sizeof(irobot_create_msgs__action__RotateAngle_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_SendGoal_Request__Sequence * array = (irobot_create_msgs__action__RotateAngle_SendGoal_Request__Sequence *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__action__RotateAngle_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__action__RotateAngle_SendGoal_Request * data =
      (irobot_create_msgs__action__RotateAngle_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__action__RotateAngle_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__action__RotateAngle_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_SendGoal_Response * msg = (irobot_create_msgs__action__RotateAngle_SendGoal_Response *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__action__RotateAngle_SendGoal_Response__Sequence__init(irobot_create_msgs__action__RotateAngle_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__action__RotateAngle_SendGoal_Response *)allocator.zero_allocate(size, sizeof(irobot_create_msgs__action__RotateAngle_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_SendGoal_Response__Sequence * array = (irobot_create_msgs__action__RotateAngle_SendGoal_Response__Sequence *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__action__RotateAngle_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__action__RotateAngle_SendGoal_Response * data =
      (irobot_create_msgs__action__RotateAngle_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__action__RotateAngle_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__action__RotateAngle_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_GetResult_Request * msg = (irobot_create_msgs__action__RotateAngle_GetResult_Request *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__action__RotateAngle_GetResult_Request__Sequence__init(irobot_create_msgs__action__RotateAngle_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__action__RotateAngle_GetResult_Request *)allocator.zero_allocate(size, sizeof(irobot_create_msgs__action__RotateAngle_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_GetResult_Request__Sequence * array = (irobot_create_msgs__action__RotateAngle_GetResult_Request__Sequence *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__action__RotateAngle_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__action__RotateAngle_GetResult_Request * data =
      (irobot_create_msgs__action__RotateAngle_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__action__RotateAngle_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__action__RotateAngle_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_GetResult_Response * msg = (irobot_create_msgs__action__RotateAngle_GetResult_Response *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__action__RotateAngle_GetResult_Response__Sequence__init(irobot_create_msgs__action__RotateAngle_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__action__RotateAngle_GetResult_Response *)allocator.zero_allocate(size, sizeof(irobot_create_msgs__action__RotateAngle_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_GetResult_Response__Sequence * array = (irobot_create_msgs__action__RotateAngle_GetResult_Response__Sequence *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__action__RotateAngle_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__action__RotateAngle_GetResult_Response * data =
      (irobot_create_msgs__action__RotateAngle_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__action__RotateAngle_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__action__RotateAngle_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_FeedbackMessage * msg = (irobot_create_msgs__action__RotateAngle_FeedbackMessage *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__action__RotateAngle_FeedbackMessage__Sequence__init(irobot_create_msgs__action__RotateAngle_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__action__RotateAngle_FeedbackMessage *)allocator.zero_allocate(size, sizeof(irobot_create_msgs__action__RotateAngle_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__action__RotateAngle_FeedbackMessage__Sequence * array = (irobot_create_msgs__action__RotateAngle_FeedbackMessage__Sequence *)allocator.allocate(sizeof(irobot_create_msgs__action__RotateAngle_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__action__RotateAngle_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__action__RotateAngle_FeedbackMessage * data =
      (irobot_create_msgs__action__RotateAngle_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__action__RotateAngle_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__action__RotateAngle_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
