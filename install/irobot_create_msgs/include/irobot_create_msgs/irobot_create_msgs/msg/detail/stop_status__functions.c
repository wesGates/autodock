...
irobot_create_msgs__msg__StopStatus__init(irobot_create_msgs__msg__StopStatus * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    irobot_create_msgs__msg__StopStatus__fini(msg);
    return false;
  }
  // is_stopped
  return true;
...
irobot_create_msgs__msg__StopStatus__create()
{
  ...
  irobot_create_msgs__msg__StopStatus * msg = (irobot_create_msgs__msg__StopStatus *)allocator.allocate(sizeof(irobot_create_msgs__msg__StopStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(irobot_create_msgs__msg__StopStatus));
  bool success = irobot_create_msgs__msg__StopStatus__init(msg);
  if (!success) {
...
irobot_create_msgs__msg__StopStatus__Sequence__init(irobot_create_msgs__msg__StopStatus__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__msg__StopStatus * data = NULL;

  if (size) {
    data = (irobot_create_msgs__msg__StopStatus *)allocator.zero_allocate(size, sizeof(irobot_create_msgs__msg__StopStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = irobot_create_msgs__msg__StopStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        irobot_create_msgs__msg__StopStatus__fini(&data[i - 1]);
      }
...
irobot_create_msgs__msg__StopStatus__Sequence__fini(irobot_create_msgs__msg__StopStatus__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      irobot_create_msgs__msg__StopStatus__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__msg__StopStatus__Sequence * array = (irobot_create_msgs__msg__StopStatus__Sequence *)allocator.allocate(sizeof(irobot_create_msgs__msg__StopStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = irobot_create_msgs__msg__StopStatus__Sequence__init(array, size);
  if (!success) {
...
irobot_create_msgs__msg__StopStatus__Sequence__destroy(irobot_create_msgs__msg__StopStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    irobot_create_msgs__msg__StopStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
irobot_create_msgs__msg__StopStatus__Sequence__are_equal(const irobot_create_msgs__msg__StopStatus__Sequence * lhs, const irobot_create_msgs__msg__StopStatus__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!irobot_create_msgs__msg__StopStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  irobot_create_msgs__msg__StopStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(irobot_create_msgs__msg__StopStatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    irobot_create_msgs__msg__StopStatus * data =
      (irobot_create_msgs__msg__StopStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__msg__StopStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__msg__StopStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!irobot_create_msgs__msg__StopStatus__copy(
