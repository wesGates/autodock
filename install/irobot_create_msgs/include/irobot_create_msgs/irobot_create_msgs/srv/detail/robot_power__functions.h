...
#ifndef IROBOT_CREATE_MSGS__SRV__DETAIL__ROBOT_POWER__FUNCTIONS_H_
#define IROBOT_CREATE_MSGS__SRV__DETAIL__ROBOT_POWER__FUNCTIONS_H_
...
/// Initialize srv/RobotPower message.
/**
...
/// Finalize srv/RobotPower message.
/**
...
/// Create srv/RobotPower message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * irobot_create_msgs__srv__RobotPower_Request__init().
...
/// Destroy srv/RobotPower message.
/**
 * It calls
 * irobot_create_msgs__srv__RobotPower_Request__fini()
...
/// Check for srv/RobotPower message equality.
/**
...
/// Initialize array of srv/RobotPower messages.
/**
...
/// Finalize array of srv/RobotPower messages.
/**
 * It calls
 * irobot_create_msgs__srv__RobotPower_Request__fini()
...
/// Create array of srv/RobotPower messages.
/**
 * It allocates the memory for the array and calls
 * irobot_create_msgs__srv__RobotPower_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RobotPower messages.
/**
 * It calls
 * irobot_create_msgs__srv__RobotPower_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RobotPower message array equality.
/**
...
/// Copy an array of srv/RobotPower messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * irobot_create_msgs__srv__RobotPower_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_irobot_create_msgs
...
/**
 * It calls
 * irobot_create_msgs__srv__RobotPower_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_irobot_create_msgs
...
/**
 * It allocates the memory for the array and calls
 * irobot_create_msgs__srv__RobotPower_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_irobot_create_msgs
...
/**
 * It calls
 * irobot_create_msgs__srv__RobotPower_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IROBOT_CREATE_MSGS__SRV__DETAIL__ROBOT_POWER__FUNCTIONS_H_
