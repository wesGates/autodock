...
{
  new (message_memory) irobot_create_msgs::msg::HazardDetection(_init);
}

void HazardDetection_fini_function(void * message_memory)
{
  auto typed_message = static_cast<irobot_create_msgs::msg::HazardDetection *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HazardDetection_message_member_array[2] = {
  {
    ...
    offsetof(irobot_create_msgs::msg::HazardDetection, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(irobot_create_msgs::msg::HazardDetection, type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HazardDetection_message_members = {
  ...
  2,  // number of fields
  sizeof(irobot_create_msgs::msg::HazardDetection),
...
{
  return &::irobot_create_msgs::msg::rosidl_typesupport_introspection_cpp::HazardDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, irobot_create_msgs, msg, HazardDetection)() {
  return &::irobot_create_msgs::msg::rosidl_typesupport_introspection_cpp::HazardDetection_message_type_support_handle;
}
