...
static const _ResetPose_Request_type_support_symbol_names_t _ResetPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, irobot_create_msgs, srv, ResetPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, irobot_create_msgs, srv, ResetPose_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, irobot_create_msgs, srv, ResetPose_Request)() {
  return &::irobot_create_msgs::srv::rosidl_typesupport_c::ResetPose_Request_message_type_support_handle;
}
...
static const _ResetPose_Response_type_support_symbol_names_t _ResetPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, irobot_create_msgs, srv, ResetPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, irobot_create_msgs, srv, ResetPose_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, irobot_create_msgs, srv, ResetPose_Response)() {
  return &::irobot_create_msgs::srv::rosidl_typesupport_c::ResetPose_Response_message_type_support_handle;
}
...
static const _ResetPose_type_support_symbol_names_t _ResetPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, irobot_create_msgs, srv, ResetPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, irobot_create_msgs, srv, ResetPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, irobot_create_msgs, srv, ResetPose)() {
  return &::irobot_create_msgs::srv::rosidl_typesupport_c::ResetPose_service_type_support_handle;
}
