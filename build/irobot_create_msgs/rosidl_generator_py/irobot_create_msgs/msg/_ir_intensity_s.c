...
bool irobot_create_msgs__msg__ir_intensity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("irobot_create_msgs.msg._ir_intensity.IrIntensity", full_classname_dest, 48) == 0);
  }
  irobot_create_msgs__msg__IrIntensity * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of IrIntensity */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("irobot_create_msgs.msg._ir_intensity");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IrIntensity");
