...
irobot_create_msgs__msg__KidnapStatus__create()
{
  ...
  irobot_create_msgs__msg__KidnapStatus * msg = (irobot_create_msgs__msg__KidnapStatus *)allocator.allocate(sizeof(irobot_create_msgs__msg__KidnapStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__msg__KidnapStatus__Sequence__init(irobot_create_msgs__msg__KidnapStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__msg__KidnapStatus *)allocator.zero_allocate(size, sizeof(irobot_create_msgs__msg__KidnapStatus), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irobot_create_msgs__msg__KidnapStatus__Sequence * array = (irobot_create_msgs__msg__KidnapStatus__Sequence *)allocator.allocate(sizeof(irobot_create_msgs__msg__KidnapStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__msg__KidnapStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__msg__KidnapStatus * data =
      (irobot_create_msgs__msg__KidnapStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__msg__KidnapStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__msg__KidnapStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
