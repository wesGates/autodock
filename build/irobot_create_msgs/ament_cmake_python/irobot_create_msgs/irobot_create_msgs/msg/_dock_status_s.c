...
bool irobot_create_msgs__msg__dock_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("irobot_create_msgs.msg._dock_status.DockStatus", full_classname_dest, 46) == 0);
  }
  irobot_create_msgs__msg__DockStatus * ros_message = _ros_message;
  {  // header
...
PyObject * irobot_create_msgs__msg__dock_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("irobot_create_msgs.msg._dock_status");
