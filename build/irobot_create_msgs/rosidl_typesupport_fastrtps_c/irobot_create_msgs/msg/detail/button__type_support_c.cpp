...
#include "irobot_create_msgs/msg/detail/button__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/detail/duration__functions.h"  // last_pressed_duration
#include "builtin_interfaces/msg/detail/time__functions.h"  // last_start_pressed_time
...
using _Button__ros_msg_type = irobot_create_msgs__msg__Button;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: last_start_pressed_time
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->last_start_pressed_time, cdr))
    {
      return false;
    }
  }

  // Field name: last_pressed_duration
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->last_pressed_duration, cdr))
    {
      return false;
    }
  }
...
static uint32_t _Button__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_irobot_create_msgs__msg__Button(
...
static size_t _Button__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_irobot_create_msgs__msg__Button(
