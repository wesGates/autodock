  ...
  std::ostream & out)
{
  ...
  {
    out << "ticks_left: ";
    rosidl_generator_traits::value_to_yaml(msg.ticks_left, out);
    out << ", ";
  }
  ...
  {
    out << "ticks_right: ";
    rosidl_generator_traits::value_to_yaml(msg.ticks_right, out);
  }
  out << "}";
...
inline std::string to_yaml(const WheelTicks & msg, bool use_flow_style = false)
{
