...
#include "irobot_create_msgs/msg/detail/interface_buttons__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const irobot_create_msgs::msg::Button &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
// functions for irobot_create_msgs::msg::Button already declared above
...
cdr_serialize(
  const irobot_create_msgs::msg::InterfaceButtons & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  irobot_create_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.button_1,
    cdr);
  // Member: button_power
  irobot_create_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.button_power,
    cdr);
  // Member: button_2
  irobot_create_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.button_2,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  irobot_create_msgs::msg::InterfaceButtons & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_irobot_create_msgs
max_serialized_size_InterfaceButtons(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: button_1
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        irobot_create_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Button(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const irobot_create_msgs::msg::InterfaceButtons *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<irobot_create_msgs::msg::InterfaceButtons *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _InterfaceButtons__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const irobot_create_msgs::msg::InterfaceButtons *>(
...
static size_t _InterfaceButtons__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_InterfaceButtons(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _InterfaceButtons__callbacks = {
...
static rosidl_message_type_support_t _InterfaceButtons__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_InterfaceButtons__callbacks,
...
{
  return &irobot_create_msgs::msg::typesupport_fastrtps_cpp::_InterfaceButtons__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irobot_create_msgs, msg, InterfaceButtons)() {
  return &irobot_create_msgs::msg::typesupport_fastrtps_cpp::_InterfaceButtons__handle;
}
