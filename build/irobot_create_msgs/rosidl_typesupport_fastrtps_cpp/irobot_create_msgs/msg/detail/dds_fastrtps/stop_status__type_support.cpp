...
#include "irobot_create_msgs/msg/detail/stop_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const irobot_create_msgs::msg::StopStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  irobot_create_msgs::msg::StopStatus & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const irobot_create_msgs::msg::StopStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<irobot_create_msgs::msg::StopStatus *>(
    untyped_ros_message);
...
{
  return &irobot_create_msgs::msg::typesupport_fastrtps_cpp::_StopStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irobot_create_msgs, msg, StopStatus)() {
  return &irobot_create_msgs::msg::typesupport_fastrtps_cpp::_StopStatus__handle;
}
