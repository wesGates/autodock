...
#include "irobot_create_msgs/msg/detail/audio_note_vector__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const irobot_create_msgs::msg::AudioNote &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const irobot_create_msgs::msg::AudioNoteVector & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  irobot_create_msgs::msg::AudioNoteVector & ros_message)
{
  // Member: header
  ...
  // Member: notes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.notes[index], current_alignment);
    }
  }
  // Member: append
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: notes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        irobot_create_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_AudioNote(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const irobot_create_msgs::msg::AudioNoteVector *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<irobot_create_msgs::msg::AudioNoteVector *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AudioNoteVector__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const irobot_create_msgs::msg::AudioNoteVector *>(
...
static size_t _AudioNoteVector__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AudioNoteVector(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AudioNoteVector__callbacks = {
...
static rosidl_message_type_support_t _AudioNoteVector__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AudioNoteVector__callbacks,
...
{
  return &irobot_create_msgs::msg::typesupport_fastrtps_cpp::_AudioNoteVector__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irobot_create_msgs, msg, AudioNoteVector)() {
  return &irobot_create_msgs::msg::typesupport_fastrtps_cpp::_AudioNoteVector__handle;
}
