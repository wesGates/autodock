...
#include "irobot_create_msgs/srv/detail/reset_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const irobot_create_msgs::srv::ResetPose_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  irobot_create_msgs::srv::ResetPose_Request & ros_message)
{
  // Member: pose
...
{
  auto typed_message =
    static_cast<const irobot_create_msgs::srv::ResetPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<irobot_create_msgs::srv::ResetPose_Request *>(
    untyped_ros_message);
...
{
  return &irobot_create_msgs::srv::typesupport_fastrtps_cpp::_ResetPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irobot_create_msgs, srv, ResetPose_Request)() {
  return &irobot_create_msgs::srv::typesupport_fastrtps_cpp::_ResetPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_irobot_create_msgs
cdr_serialize(
  const irobot_create_msgs::srv::ResetPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  irobot_create_msgs::srv::ResetPose_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const irobot_create_msgs::srv::ResetPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<irobot_create_msgs::srv::ResetPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &irobot_create_msgs::srv::typesupport_fastrtps_cpp::_ResetPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irobot_create_msgs, srv, ResetPose_Response)() {
  return &irobot_create_msgs::srv::typesupport_fastrtps_cpp::_ResetPose_Response__handle;
}
...
{
  return &irobot_create_msgs::srv::typesupport_fastrtps_cpp::_ResetPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irobot_create_msgs, srv, ResetPose)() {
  return &irobot_create_msgs::srv::typesupport_fastrtps_cpp::_ResetPose__handle;
}
