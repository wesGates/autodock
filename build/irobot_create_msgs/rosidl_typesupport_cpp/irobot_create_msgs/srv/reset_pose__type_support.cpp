...
static const _ResetPose_Request_type_support_symbol_names_t _ResetPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irobot_create_msgs, srv, ResetPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, irobot_create_msgs, srv, ResetPose_Request)),
  }
};
...
{
  return &::irobot_create_msgs::srv::rosidl_typesupport_cpp::ResetPose_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, irobot_create_msgs, srv, ResetPose_Request)() {
  return get_message_type_support_handle<irobot_create_msgs::srv::ResetPose_Request>();
}
...
static const _ResetPose_Response_type_support_symbol_names_t _ResetPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irobot_create_msgs, srv, ResetPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, irobot_create_msgs, srv, ResetPose_Response)),
  }
};
...
{
  return &::irobot_create_msgs::srv::rosidl_typesupport_cpp::ResetPose_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, irobot_create_msgs, srv, ResetPose_Response)() {
  return get_message_type_support_handle<irobot_create_msgs::srv::ResetPose_Response>();
}
...
static const _ResetPose_type_support_symbol_names_t _ResetPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irobot_create_msgs, srv, ResetPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, irobot_create_msgs, srv, ResetPose)),
  }
};
...
{
  return &::irobot_create_msgs::srv::rosidl_typesupport_cpp::ResetPose_service_type_support_handle;
}
