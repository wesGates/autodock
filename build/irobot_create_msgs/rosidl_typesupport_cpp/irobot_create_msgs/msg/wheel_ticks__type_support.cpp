...
static const _WheelTicks_type_support_symbol_names_t _WheelTicks_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irobot_create_msgs, msg, WheelTicks)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, irobot_create_msgs, msg, WheelTicks)),
  }
};
...
{
  return &::irobot_create_msgs::msg::rosidl_typesupport_cpp::WheelTicks_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, irobot_create_msgs, msg, WheelTicks)() {
  return get_message_type_support_handle<irobot_create_msgs::msg::WheelTicks>();
}
